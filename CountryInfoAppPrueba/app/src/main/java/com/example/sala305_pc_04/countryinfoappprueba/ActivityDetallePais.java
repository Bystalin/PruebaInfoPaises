...
public class ActivityDetallePais extends AppCompatActivity implements Asynchtask {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebService ws= new WebService("http://www.geognos.com/api/en/countries/info/"+ bundle.getString("Codigo2") +".json",
         datos,ActivityDetallePais.this, ActivityDetallePais.this);
        ws.execute("");
